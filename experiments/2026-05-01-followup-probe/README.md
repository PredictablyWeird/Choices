...
uv run python experiments/2026-05-01-followup-probe/run_followup.py \
    --benchmark trolley \
    --model gpt-5-2-non-reasoning \
    --samples-per-condition 100 \
    --concurrency 50 \
    --output experiments/2026-05-01-followup-probe/results/followup_trolley_gpt-5-2-non-reasoning.jsonl
...
uv run python experiments/2026-05-01-followup-probe/classify.py \
    --input experiments/2026-05-01-followup-probe/results/followup_trolley_gpt-5-2-non-reasoning.jsonl \
    --output experiments/2026-05-01-followup-probe/results/classified_trolley_gpt-5-2-non-reasoning.jsonl \
...
uv run python experiments/2026-05-01-followup-probe/analyze.py \
    --classified experiments/2026-05-01-followup-probe/results/classified_*.jsonl \
    --summary-csvs ../2026-05-01-asymmetry-baseline-regression/data/{trolley,bbq}_summary.csv \
    --output-dir experiments/2026-05-01-followup-probe/analysis_out
```
