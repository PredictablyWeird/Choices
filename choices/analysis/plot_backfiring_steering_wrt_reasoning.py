...
def create_bar_charts(input_file, output_dir='plots'):
    ...
    nudge_types = ['emotional', 'few_shot_3', 'survey_preference', 'user_preference', 'weak_evidence']
    ...
    ax1.set_xlabel('Nudge Type', fontsize=16, fontweight='bold', labelpad=10)
    ...
    legend1 = ax1.legend(fontsize=13, loc='upper right', frameon=True,
    ...
    # Style axes with larger fonts, no title
    ax2.set_xlabel('Nudge Type', fontsize=16, fontweight='bold', labelpad=10)
    ax2.set_ylabel('Mean Absolute Steerability', fontsize=16, fontweight='bold', labelpad=10)
    ax2.set_xticks(x)
    ...
    # Legend with clean styling and larger font
    legend2 = ax2.legend(fontsize=13, loc='upper right', frameon=True,
                         fancybox=True, shadow=False, edgecolor='#cccccc')
...
if __name__ == "__main__":
    input_file = "main_results_jan26.csv"
